...
public class LoginForm extends JFrame implements ActionListener
{
    ...
    JPanel panel;
    JLabel lab1,lab2,picLab,userLab,adminLab,textLabel;
    JCheckBox box;
    JButton btn1,btn2;
    JTextField Tfield;
    ...
    {  
        ...
        headerLabel = new JLabel("Welcome to Our ATM System");
        headerLabel.setFont(new Font("Arial", Font.BOLD, 24));
        headerPanel.add(headerLabel);
        
        // Add headerPanel to the JFrame
        add(headerPanel, BorderLayout.NORTH);
       
        panel = new JPanel();
        textLabel = new JLabel("Swipe and Conquer");
